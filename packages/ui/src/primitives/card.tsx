...
export function Card({ className, ...props }: HTMLAttributes<HTMLDivElement>): JSX.Element {
  return (
    <section
      className={cx(
        "rounded-lg border border-slate-200 bg-white shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-950",
        className
      )}
      {...props}
    />
...
export function CardHeader({ className, ...props }: HTMLAttributes<HTMLDivElement>): JSX.Element {
  return (
    <div
      className={cx("border-b border-slate-200 px-4 py-3 dark:border-slate-800", className)}
      {...props}
    />
  );
}
...
export function CardTitle({
  ...
  return (
    <h2
      className={cx("text-sm font-semibold text-slate-950 dark:text-slate-100", className)}
      {...props}
    />
  );
}
